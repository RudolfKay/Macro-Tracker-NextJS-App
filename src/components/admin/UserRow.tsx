...
export const UserRow: React.FC<UserRowProps> = ({ user, isCurrentUser, onEdit, onDelete }) => {
  ...
  return (
    <div
      className="flex items-center gap-4 py-4 px-2 group hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded transition cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"
      tabIndex={0}
