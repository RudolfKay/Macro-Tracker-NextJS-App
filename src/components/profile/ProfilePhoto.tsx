...
export const ProfilePhoto: React.FC<ProfilePhotoProps> = ({ src, preview, uploading, onClick, onFileChange, onRemove, fileInputRef, onImageError }) => (
  <div className="relative group cursor-pointer bg-white dark:bg-neutral-400 rounded-full w-[140px] h-[140px] flex items-center justify-center" onClick={onClick} tabIndex={0} aria-label="Change profile photo">
    <Image
      src={preview || src}
      alt="Profile photo"
      width={111}
